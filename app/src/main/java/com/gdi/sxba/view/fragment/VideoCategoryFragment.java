...
import com.gdi.sxba.presenter.VideoPresenter;
import com.gdi.sxba.view.activity.NovelActivity;
import com.gdi.sxba.view.activity.VideoActivity;
import com.gdi.sxba.view.adapter.VideoAdapter;
...
public class VideoCategoryFragment extends Fragment implements UIContract.View<VideoBean>, OnItemClickLitener {

    private static final String TAG = "NovelCategoryFragment";

    public static VideoCategoryFragment instance;
    View mView;
    String url;
    String title="";
    VideoPresenter presenter;
    VideoAdapter videoAdapter;
    List<VideoBean.VideoData> videoList = new ArrayList<>();
            ...
            switch (msg.what) {
                ...
                case HANDLER_CRAWLER_SUCCESS:
                    ...
                    if (msg.arg1 == notifyFrist) {
                        ...
                        videoAdapter.notifyItemRangeInserted((int) msg.obj, videoList.size() - 1);
                    }
    ...
    public VideoCategoryFragment(String url) {
        this.url = url;
    ...
    private void init() {
        ...
        videoAdapter.setOnItemClickLitener(this);
...
//                startActivity(intent);
    ...
    @Override
    public void notifyDataSetChanged(int type, VideoBean result) {
        ...
        videoList.addAll(result.getVideoData());
    ...
    public void setOnItemClickLitener(View view, int position) {
        EventBus.getDefault().postSticky(videoList.get(position));
        Intent intent = new Intent(getActivity(), VideoActivity.class);
        startActivity(intent);
    }
